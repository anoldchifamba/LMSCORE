...
<head>
    ...
    <link rel="shortcut icon" href="log/headericon-removebg-preview (1).png" type="image/x-icon">
    <!-- Bootstrap CSS -->
    ...
    <title>Atacademy Online University </title>
    {{-- one signal --}}
...
<nav class="navbar navbar-expand-lg navbar-light bg-white">
    ...
    <div class="collapse navbar-collapse " id="navbarSupportedContent">
        ...
        <form class="form-inline my-2 my-lg-0 inbutton">
            <input class="form-control form-control-lg mr-sm-0 col-10 bg-light border-0 "
...
{{--         anywhere.">Atacademy for Business</a>--}}
        <a class="nav-link btn btn-light  mx-2" href="/login">Become an Instructor</a>
      ...
      <div class="container">
            ...
            <div class="row align-items-center">
              ...
              <div class="col">
                ...
                style=" background:rgba(151, 19, 19, 0.6); border-radius: 10px;     margin-top: -50px;">
            ...
            <div class="col-md-4">
                <div class="media">
                    ...
                    <div class="media-body">
                        ...
                        Learn on your terms with lifetime course access and the Atacademy mobile app
                    </div>
                </div>
            </div>
        ...
        @foreach($courses as $course)
            <div class="card mx-2"style="width: 18rem;" >
                ...
                <a href="/courses/{{ $course->id }}" class="card-img-top h-50"  >
                    <img class="card-img-top" src="{{  asset('storage/course_image/'.$course->photo)}}" alt="{{  str_limit($course->title ,$limit=40 ,$end='...')}}"  />
                </a>
                <br/>
                <div class="card-body px-2">
                    <h6>{{ $course->title }}</h6>
                    <p class="card-text" style="font-size: 11px;"><i class="fa fa-user"></i>{{ $course->user['name'] }} | {{ $course->sub_title }}</p>
                    <small class="text-muted  " style="font-size: 8px;">Posted on {{ $course->created_at->format('h :i a - D d M Y') }}</small>
                   ...
                   <br/>
                            ...
                            <small style="font-size: 25px;text-decoration: ; color:brown;" >
    ...
    <marquee>
       <div class="row">
         ...
         <div class="col-md-4">
            <a href="#" >
                <figure class="figure">
                    <img src="/images/programming.jpeg" style="height: 250px;" class="figure-img img-fluid rounded" alt="A generic square placeholder image with rounded corners in a figure.">
         ...
         <div class="col-md-4">
            <a href="#" >
                <figure class="figure">
                    <img src="/images/boss.png" style="height: 250px;" class="figure-img img-fluid rounded" alt="A generic square placeholder image with rounded corners in a figure.">
                    <figcaption class="figure-caption text-center">
        ...
        <div class="col text-center border-right">
            ...
            <div class="col text-center ">
                <div class="col-8 offset-1">
                    ...
                    <p class="lead" style="font-size: 12px;">Teach what you love. Atacademy gives you tools to create an online course.</p>
                    <a href="/login" class="btn btn-lg btn-danger">Start Teaching</a>
                </div>
...
{{--                 <div class="col-8 offset-1">--}}
{{--                 <h4>ATacademy for Business</h4>--}}
{{--                 <p class="lead" style="font-size: 12px;">Get unlimited access to 2,500 of Atacademy’s top courses for your team.</p>--}}
{{--                 <a href="#" class="btn btn-lg btn-danger">Get into business</a>--}}
{{--             </div>--}}
 ...
 <div class="row pt-5 px-3 border-top mt-5 " style="font-size: 13px;">
  <div class="col">
    ...
    <ul class="nav flex-column">
        <li class="nav-item">
          <a class="nav-link text-info" href="#"><b>Atacademy for business</b></a>
        </li>
        <li class="nav-item">

                <a href="/login "  class="nav-link text-info"><b>Become and Instructor</b></a>
...
<script type="text/javascript">
    ...
    (function(){
        ...
        s1.async=true;
        s1.src='https://embed.tawk.to/5f3fd6f21e7ade5df442d561/default';
        s1.charset='UTF-8';
